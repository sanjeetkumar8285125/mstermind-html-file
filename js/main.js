...
$('.service-property-slider1').slick({
  infinite: true,
  autoplay: true,
  arrows: true,
  loop:true,
...
//loan available slide js

$(function(){
		$('#floating-loan-form').hide();
	})
		$('#floating-loan-form-viewer').click(function(){
			$('#floating-loan-form').toggle(100);
		})
